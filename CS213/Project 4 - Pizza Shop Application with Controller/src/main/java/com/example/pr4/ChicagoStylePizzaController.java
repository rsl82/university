...
/**
 * This class is the controller for ChicagoStylePizzaView.
...
public class ChicagoStylePizzaController {
    ...
    /**
     * This method initializes the ChicagoStylePizzaView.
    ...
    public void setMainController(MainViewController mainViewController) {
        imageView.setImage(new Image(getClass().getResourceAsStream("chicago_pizza_main.jpg")));
    ...
    private void changeImage() {
        if(flavorBox.getSelectionModel().getSelectedItem().toString().equals("Deluxe")) {
            imageView.setImage(new Image(getClass().getResourceAsStream("chicago_deluxe.jpeg")));

        }
        else if(flavorBox.getSelectionModel().getSelectedItem().toString().equals("BBQ Chicken")) {
            imageView.setImage(new Image(getClass().getResourceAsStream("chicago_bbqchicken.jpeg")));

        }
        else if(flavorBox.getSelectionModel().getSelectedItem().toString().equals("Meatzza")) {
            imageView.setImage(new Image(getClass().getResourceAsStream("chicago_meatzza.jpeg")));

        }
        else if(flavorBox.getSelectionModel().getSelectedItem().toString().equals("Build Your Own")) {
            imageView.setImage(new Image(getClass().getResourceAsStream("chicago_build_your_own.jpeg")));
        }
    }
