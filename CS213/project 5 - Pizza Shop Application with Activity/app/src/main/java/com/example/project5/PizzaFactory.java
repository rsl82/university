...
public interface PizzaFactory {
     ...
     */
    Pizza createDeluxe(Size size, ArrayList<Topping> toppings);
     ...
     * @return new deluxe pizza object.
     */
    Pizza createMeatzza(Size size, ArrayList<Topping> toppings);
     ...
     * @return new deluxe pizza object.
     */
    Pizza createBBQChicken(Size size, ArrayList<Topping> toppings);
