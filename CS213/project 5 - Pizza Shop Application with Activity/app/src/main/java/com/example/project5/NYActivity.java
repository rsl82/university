...
/**
 * Activity Class to control New York Pizza window.
...
public class NYActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("New York Pizza Order");
    ...
    private void makePizza() {
        ...
        if(currentFlavor.equals("BBQ Chicken")) {
            ...
            currentPizza = nyFactory.createBBQChicken(Size.getSize(currentSize),addedToppings);
        }
        else if(currentFlavor.equals("Deluxe")) {
            leftAdapter.changeClick(false);
            addedAdapter.changeClick(false);
            currentPizza = nyFactory.createDeluxe(Size.getSize(currentSize),addedToppings);
        }
        else if(currentFlavor.equals("Meatzza")) {
            leftAdapter.changeClick(false);
            addedAdapter.changeClick(false);
            currentPizza = nyFactory.createMeatzza(Size.getSize(currentSize),addedToppings);
        }
        else {
            leftAdapter.changeClick(true);
            addedAdapter.changeClick(true);
            currentPizza = nyFactory.createBuildYourOwn(Size.getSize(currentSize));
            leftToppingCount = 13;
            addedToppingCount = 0;
        }
        leftAdapter.notifyDataSetChanged();
    ...
    public void changeImage() {
        if(currentFlavor.equals("BBQ Chicken")) {
            img.setImageResource(R.drawable.ny_bbqchicken);
        }
        else if(currentFlavor.equals("Deluxe")) {
            img.setImageResource(R.drawable.ny_deluxe);
        }
        else if(currentFlavor.equals("Meatzza")) {
            img.setImageResource(R.drawable.ny_meatzza);
        }
        else if(currentFlavor.equals("Build Your Own")) {
            img.setImageResource(R.drawable.ny_build_your_own);
        }
